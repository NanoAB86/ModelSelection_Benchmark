...
from metrics import LFC, LEEP, gbc, NCE, NLEEP, LogME_Score, PAC_Score, SFDA_Score, PARC_Score, EMMS, Transrate, LDA_Score, \
    Energy_Score, Hscore1, calculate_pac_gamma, calculate_pac_gauss, calculate_pac_dir, PARC_Scorem
...
if __name__ == "__main__":
    ...
    parser.add_argument('-d', '--dataset', type=str, default='caltech101',
    ...
    for model in models_hub:
        ...
        elif args.metric == 'parcm':
            score_dict[args.model] = PARC_Scorem(X_features, y_labels)
